...
function inferAccountFromDescription(descText: string, accountName?: string): string | null {
    ...
    const CLINIC_KEYWORDS: Array<{ keywords: string[]; preferredAccountNo: string }> = [
        ...
        { keywords: ["aram"],       preferredAccountNo: "KIBAM-2290" },  // primary
        // Note: there are 3 ARAM accounts (2290, 3577, 1680). 2290 is the
        // primary/main one per constants.ts (first KIB record).
